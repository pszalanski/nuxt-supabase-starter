...
import {type SchemaSignInValidation, signInValidation} from '~/utils/formValidation'
    ...
    <div class="container mx-auto">
      <div class="flex h-[100vh] w-full justify-center items-center">
        <div class="w-10/12 md:w-8/12 lg:w-4/12 xl:w-3/12">
          <UCard>
            <UForm :schema="signInValidation" :state="form" class="space-y-2"
              ...
              <div class="space-y-4">
                ...
                <p class="text-lg font-bold text-center">Welcome Back, enter your credential
                  below.</p>
